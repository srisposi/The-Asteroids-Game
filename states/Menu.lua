...
function Menu(game, player, sfx)
    ...
    local buttons = {
        ...
        Button(funcs.quickGame, nil, nil, love.graphics.getWidth()/3, 50, "Quit", "center", "h3", love.graphics.getWidth()/3, love.graphics.getHeight() * 0.55),
    }
        ...
        run = function(self, clicked)
            ...
            for name, button in pairs(buttons) do
                if button:checkHover(mouse_x, mouse_y, 10) then
                    sfx:playFX("option_select", "single")
